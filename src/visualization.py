...
@media(max-width:600px){{.topbar{{padding:0 12px}}.wordmark small{{display:none}}.hero{{padding:45px 18px}}.shell{{padding:12px}}.filters{{grid-template-columns:repeat(2,1fr)}}.switch{{grid-template-columns:repeat(2,1fr)}}.kpis,.comparison-strip{{grid-template-columns:1fr}}.section-head{{display:block}}.section-head p{{text-align:left;margin-top:10px}}.finding{{grid-template-columns:50px 1fr}}.finding-no{{font-size:32px}}}}
</style><script>{get_plotlyjs()}</script></head><body>
<header class="topbar"><div class="wordmark">SPORTRETAIL <small>LAM INTELLIGENCE STUDIO</small></div><nav class="tabs"><a class="summary-link" href="fase-1-api-tabla-maestra.html">Fase 1</a><button class="tab active" data-page="overview">Desempeño</button><button class="tab" data-page="scenarios">Escenarios</button><button class="tab" data-page="decisions">Decisiones & ML</button><a class="summary-link" href="executive_summary.html">Resumen</a></nav></header>
<section class="hero"><div><span class="eyebrow">Business intelligence · 2024</span><h1>Move the<br>business.</h1><p>Una lectura ejecutiva del rendimiento mayorista, la incertidumbre de los datos y las acciones comerciales. Diseño autónomo: funciona sin Python, API, servidor ni conexión.</p></div><aside class="hero-aside"><div class="hero-stat"><span>Revenue observado</span><b>$4,17 M</b></div><div class="hero-stat"><span>Pedidos</span><b>200</b></div><div class="hero-stat"><span>Mercados</span><b>5 países</b></div><div class="hero-stat"><span>Estado analítico</span><b>Auditable</b></div></aside></section>
<main class="shell">
<div class="scenario-bar"><div class="scenario-copy"><b>Vista activa de cantidades e ingresos</b><small id="scenarioDescription"></small></div><div class="switch" id="scenarioSwitch"><button data-scenario="original" class="active">Original</button><button data-scenario="minimum">Mínimo</button><button data-scenario="rf">Random Forest</button><button data-scenario="maximum">Máximo</button></div></div>
