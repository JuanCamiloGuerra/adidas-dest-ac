...
table{border-collapse:collapse;width:100%;background:#fff;color:#111;font-size:12px}th{background:#000;color:#fff;text-transform:uppercase;font-size:9px;letter-spacing:.08em}th,td{padding:13px;text-align:left;border-bottom:1px solid #ccc}td small{display:block;color:#666;margin-top:3px}#s07 table tbody td,#s07 table tbody td b{color:#242424!important}#s07 table tbody td small{color:#555!important}.portfolio-kpis .card,.portfolio-kpis .card .label,.portfolio-kpis .card .big,.portfolio-kpis .card p{color:#000!important}.donut{width:230px;aspect-ratio:1;border-radius:50%;background:conic-gradient(var(--signal) 0 97.7%,#333 97.7%);display:grid;place-items:center;margin:auto}.donut:after{content:"97,7%";width:145px;aspect-ratio:1;border-radius:50%;background:#000;color:#fff;display:grid;place-items:center;font-size:34px;font-weight:900}
...
<section class="slide dark" id="s07"><span class="slide-no">07 / 15</span><span class="eyebrow">Portafolio</span><h2>Footwear es el motor.<br>El volumen es más diverso.</h2><div class="grid"><article class="card black s5"><h3>Valor por categoría</h3>__CATEGORY_BARS__</article><article class="card black s7"><table><thead><tr><th>#</th><th>Producto</th><th>Categoría</th><th>Valor</th></tr></thead><tbody>__TOP_PRODUCTS__</tbody></table></article></div><div class="grid portfolio-kpis"><article class="card signal s4"><span class="label">Footwear</span><div class="big">__FOOTWEAR_SHARE__</div><p>del valor bruto.</p></article><article class="card s4"><span class="label">Top 10 productos</span><div class="big">__TOP_PRODUCT_SHARE__</div><p>del valor: concentración manejable.</p></article><article class="card s4"><span class="label">Top 10 por valor</span><div class="big">__TOP_FOOTWEAR__/10</div><p>son Footwear.</p></article></div><p class="footnote" style="color:#aaa">El producto #1 es __TOP_PRODUCT__ con __TOP_PRODUCT_VALUE__. Recomendación: asegurar disponibilidad y margen de los héroes, pero evitar que la estrategia de surtido se vuelva monodependiente.</p></section>
