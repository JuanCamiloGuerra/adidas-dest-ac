...
*{box-sizing:border-box}html{scroll-behavior:smooth;scroll-snap-type:y mandatory}body{margin:0;background:#000;color:#111;font-family:Arial,Helvetica,sans-serif}.progress{position:fixed;top:58px;left:0;height:4px;background:var(--signal);z-index:1100;width:0;transition:width .25s}
