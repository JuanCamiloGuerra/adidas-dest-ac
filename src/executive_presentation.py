...
*{box-sizing:border-box}html{scroll-behavior:smooth;scroll-snap-type:y mandatory}body{margin:0;background:#000;color:#111;font-family:Arial,Helvetica,sans-serif}.deckbar{height:54px;position:fixed;top:0;left:0;right:0;z-index:50;background:#000;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:0 24px;border-bottom:1px solid #333}.brand{font-weight:900;letter-spacing:-.04em}.brand small{font-size:9px;color:#999;letter-spacing:.15em;margin-left:10px}.decklinks{display:flex;height:100%;align-items:center}.decklinks a,.decklinks button{height:100%;display:flex;align-items:center;background:#000;color:#aaa;border:0;border-left:1px solid #333;padding:0 16px;text-decoration:none;font:900 9px Arial;letter-spacing:.1em;text-transform:uppercase;cursor:pointer}.decklinks a:hover,.decklinks button:hover{background:#fff;color:#000}.progress{position:fixed;top:54px;left:0;height:4px;background:var(--signal);z-index:60;width:0;transition:width .25s}
...
.kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:#000;border:1px solid #000;margin-top:30px}.kpi{background:#fff;padding:22px;min-height:150px}.kpi.signal{background:var(--signal)}.kpi.orange{background:var(--orange);color:#fff}.kpi span,.label{font-size:9px;font-weight:900;letter-spacing:.1em;text-transform:uppercase}.kpi strong{display:block;font-size:clamp(27px,3vw,44px);letter-spacing:-.06em;margin:24px 0 5px}.kpi small{color:#666}.orange small{color:#fff}
.grid{display:grid;grid-template-columns:repeat(12,1fr);gap:12px;margin-top:24px}.s4{grid-column:span 4}.s5{grid-column:span 5}.s6{grid-column:span 6}.s7{grid-column:span 7}.s8{grid-column:span 8}.s12{grid-column:span 12}.card{background:#fff;border:1px solid #aaa;padding:24px}.card.black{background:#000;color:#fff;border-color:#000}.card.signal{background:var(--signal);border:2px solid #000}.card.orange{background:var(--orange);color:#fff;border-color:#000}.card p{color:#555}.black p{color:#bbb}.big{font-size:clamp(38px,5vw,70px);font-weight:900;letter-spacing:-.07em;line-height:.9}.statement{font-size:clamp(25px,3.4vw,48px);line-height:1.05;letter-spacing:-.05em;font-weight:900}.statement mark{background:var(--signal);padding:0 .1em}
...
table{border-collapse:collapse;width:100%;background:#fff;font-size:12px}th{background:#000;color:#fff;text-transform:uppercase;font-size:9px;letter-spacing:.08em}th,td{padding:13px;text-align:left;border-bottom:1px solid #ccc}td small{display:block;color:#777;margin-top:3px}.donut{width:230px;aspect-ratio:1;border-radius:50%;background:conic-gradient(var(--signal) 0 97.7%,#333 97.7%);display:grid;place-items:center;margin:auto}.donut:after{content:"97,7%";width:145px;aspect-ratio:1;border-radius:50%;background:#000;color:#fff;display:grid;place-items:center;font-size:34px;font-weight:900}
...
@media(max-width:900px){html{scroll-snap-type:none}.slide{min-height:auto;padding:90px 18px 55px}.thesis{grid-template-columns:1fr}.hero-graphic{display:none}.kpis{grid-template-columns:1fr 1fr}.s4,.s5,.s6,.s7,.s8{grid-column:span 12}.mini-grid,.roadmap{grid-template-columns:1fr}.priority{grid-template-columns:55px 1fr}.priority aside{grid-column:2}.nav-dots,.controls{display:none}.brand small{display:none}.decklinks button{display:none}}@media(max-width:520px){.kpis{grid-template-columns:1fr}.deckbar{padding:0 10px}.decklinks a{padding:0 9px;font-size:8px}.status-stack{height:auto;display:block}.status-stack div{min-height:70px}}
@media print{html{scroll-snap-type:none}.deckbar,.nav-dots,.controls,.progress{display:none}.slide{page-break-after:always;min-height:100vh;padding:50px}.slide:last-child{page-break-after:auto}}
</style></head><body>
<header class="deckbar"><div class="brand">SPORTRETAIL <small>EXECUTIVE REVIEW · 2024</small></div><nav class="decklinks"><a href="fase-1-api-tabla-maestra.html">Fase 1</a><a href="index.html">Dashboard</a><button onclick="window.print()">Imprimir / PDF</button></nav></header><div class="progress" id="progress"></div><nav class="nav-dots" id="dots"></nav><div class="controls"><button id="prev" aria-label="Anterior">←</button><button id="next" aria-label="Siguiente">→</button></div>
