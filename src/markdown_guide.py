...
<header class="hero"><span>Fase 2 · Guía narrativa</span><h1>El proyecto,<br>paso a paso.</h1><p>Lectura continua de las explicaciones del notebook principal. El código, las salidas ejecutadas y las tablas completas permanecen en el archivo reproducible.</p><a href="https://github.com/JuanCamiloGuerra/adidas-dest-ac/blob/main/notebooks/guia_integral_para_entender_proyecto_sportretail.ipynb" target="_blank" rel="noopener noreferrer">Abrir notebook completo →</a></header>
